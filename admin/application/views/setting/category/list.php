...
echo form_open_multipart(base_url("setting/categories"), $attributes);
?>
    <div id="tool_bar" class="container-fluid">
        <div class="row justify-content-between">
            <div class="col-sm-auto tool_bar">
                <a href="<?php echo base_url("setting/add_categories")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>
                ...
                <button type="button" onclick="set_task('copy', 'main_form', 'check_checklist')" class="btn btn-outline-secondary btn-sm mb-1"><?=lang('copy')?></button>
            ...
            <div class="col">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><a href="#">اولین دسته بندی</a></td>
                        <td class="text-center"><i class="fas fa-star"></i></td>
                    </tr>
                    <tr>
                        <th scope="row"><input type="checkbox"></th>
                        <td><a href="#">دومین دسته بندی</a></td>
                        <td class="text-center"><i class="far fa-star"></i></td>
                    </tr>
                    <tr>
                        <th scope="row"><input type="checkbox"></th>
                        <td><a href="#">سومین دسته بندی</a></td>
                        <td class="text-center"><i class="far fa-star"></i></td>
                    </tr>
                    </tbody>
                </table>
