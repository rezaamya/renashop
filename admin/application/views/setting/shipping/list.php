...
echo form_open_multipart(base_url("setting/shipping/".$this->uri->segment(3)), $attributes);
?>
    <div id="tool_bar" class="container-fluid">
        <div class="row justify-content-between">
            <div class="col-sm-auto tool_bar">
                <!--<a href="<?php echo base_url("setting/add_shipping")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>-->
        ...
        <div class="col">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th scope="col"><?=lang('shipping_method')?></th>
