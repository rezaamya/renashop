...
echo form_open_multipart(base_url("options/".$this->uri->segment(2)), $attributes);
?>
    <div id="tool_bar" class="container-fluid">
        <div class="row justify-content-between">
            <div class="col-sm-auto tool_bar">
                <a href="<?php echo base_url("options/add")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>
            ...
            <div class="col-sm-auto">
                <div class="form-inline">
                    ...
                    <input class="form-control col-10 col-sm-auto fix_popover" type="search" name="search" placeholder="<?=lang('search')?>" value="<?php echo set_value('search',$html_output['search']); ?>">
            ...
            <div class="col">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?=lang('option_name')?></th>
                        <th class="fit" scope="col"><?=lang('products_categories')?></th>
