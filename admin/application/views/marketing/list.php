...
echo form_open_multipart(base_url("marketing/".$this->uri->segment(2)), $attributes);
?>
<div id="tool_bar" class="container-fluid">
    <div class="row justify-content-between">
        <div class="col-sm-auto tool_bar">
            <a href="<?php echo base_url("marketing/add")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>
        ...
        <div class="col">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th scope="col"><?=lang('campaign_name')?></th>
                    <th class="fit" scope="col"><?=lang('clicks')?></th>
                    <th class="fit" scope="col"><?=lang('created')?></th>
