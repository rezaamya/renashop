...
<div class="container-fluid">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="addresses" data-toggle="tab" href="#contact" role="tab"><?=lang('addresses')?></a>
        </li>
        <li class="nav-item">
    ...
    echo form_open_multipart(base_url("marketing/add_affiliates"), $attributes);
    ?>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="first_name" type="text" class="form-control" id="first_name" placeholder="<?=lang('first_name')?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="last_name" class="col-sm-2 col-form-label"><?=lang('last_name')?></label>
                        <div class="col-sm-10">
                            <input name="last_name" type="text" class="form-control" id="last_name" placeholder="<?=lang('last_name')?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label"><?=lang('username')?></label>
                        <div class="col-sm-10">
                            <input name="username" type="text" class="form-control" id="username" placeholder="<?=lang('username')?>">
                        </div>
                    </div>
                    <div class="form-group row">
