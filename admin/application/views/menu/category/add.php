...
<div id="tool_bar" class="container-fluid">
    <div class="row justify-content-between">
        <div class="col-sm-auto">
            ...
            <a href="<?php echo base_url("menu/categories")?>"><span class="btn btn-danger btn-sm mb-1"><?=lang('cancel')?></span></a>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col">
            ...
            echo form_open_multipart(base_url("menu/add_categories/".$html_output['item_data']['id']), $attributes);
            ?>
