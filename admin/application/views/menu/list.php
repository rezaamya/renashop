...
echo form_open_multipart(base_url("menu/".$this->uri->segment(2)), $attributes);
?>
    <div id="tool_bar" class="container-fluid">
        <div class="row justify-content-between">
            <div class="col-sm-auto tool_bar">
                <a href="<?php echo base_url("menu/add")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>
            ...
            <div class="col">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?=lang('menu_category')?></th>
