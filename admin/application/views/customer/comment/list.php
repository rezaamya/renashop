...
echo form_open_multipart(base_url("customer/comments_list/".$this->uri->segment(3)), $attributes);
?>
    <div id="tool_bar" class="container-fluid">
        <div class="row justify-content-between">
            <div class="col-sm-auto tool_bar">
                <button type="button" onclick="set_task('edit_comment', 'main_form', 'check_checklist')" class="btn btn-success btn-sm mb-1"><?=lang('view')?></button>
