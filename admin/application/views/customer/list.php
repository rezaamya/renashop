...
echo form_open_multipart(base_url("customer/".$this->uri->segment(2)), $attributes);
?>
    <div id="tool_bar" class="container-fluid">
    <div class="row justify-content-between">
        <div class="col-sm-auto tool_bar">
			<a href="<?php echo base_url("customer/edit")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>
        ...
        <div class="col">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th scope="col"><?=lang('user_position')?></th>
