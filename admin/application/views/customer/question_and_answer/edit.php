...
?><div id="tool_bar" class="container-fluid">
    <div class="row justify-content-between">
        <div class="col-sm-auto">
            ...
            <a href="<?php echo base_url("customer/question_and_answer")?>"><span class="btn btn-danger btn-sm mb-1"><?=lang('cancel')?></span></a>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col">
            ...
            echo form_open_multipart(base_url("customer/edit_question_and_answer/".$html_output['item_data']['id']), $attributes);
            ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-2 col-form-label"><?=lang('question')?></div>
                    <div class="col-sm-10">
                        <textarea name="question" class="form-control" id="question" rows="5"><?php echo set_value('question',$html_output['item_data']['question']); ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
