...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col">
			...
			echo form_open_multipart(base_url("payment/mellat/".$html_output['item_data']['id']), $attributes);
			?>
            ...
            <div class="form-group row">
                <div class="col-sm-2 col-form-label"><?=lang('password')?></div>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="password" placeholder="<?=lang('password')?>" value="<?php echo set_value('password',$html_output['item_data']['extra']->password); ?>">
                </div>
            </div>
