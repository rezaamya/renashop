...
echo form_open_multipart(base_url("products/brands/".$this->uri->segment(3)), $attributes);
?>
    <div id="tool_bar" class="container-fluid">
        <div class="row justify-content-between">
            <div class="col-sm-auto tool_bar">
                <a href="<?php echo base_url("products/add_brand")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>
