...
echo form_open_multipart(base_url("articles/".$this->uri->segment(2)), $attributes);
?>
<div id="tool_bar" class="container-fluid">
    <div class="row justify-content-between">
        <div id="tool_bar" class="col-sm-auto tool_bar">
            <a href="<?php echo base_url("articles/add")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>
