...
echo form_open_multipart(base_url("articles/categories/".$this->uri->segment(3)), $attributes);
?>
<div id="tool_bar" class="container-fluid">
    <div class="row justify-content-between">
        <div class="col-sm-auto tool_bar">
            <a href="<?php echo base_url("articles/add_category")?>"><span class="btn btn-success btn-sm mb-1"><?=lang('new')?></span></a>
        ...
        <div class="col-sm-auto">
            <div class="form-inline">
                ...
                <button class="btn btn-outline-success btn-sm my-2 my-sm-0 col-2 col-sm-auto" type="submit" name="sub"><?=lang('do_search')?></button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col">
            <table class="table table-hover">
                <thead>
                <tr>
                    <th class="fit" scope="col"><input type="checkbox" name="publish" onclick="toggle_checklist(this)"></th>
