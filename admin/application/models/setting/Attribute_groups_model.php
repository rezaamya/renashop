...
class Attribute_groups_model extends CI_Model {
	private $db_table_name = 'attribute_groups';
	...
	public function find_attribute_groups($condition_array)
	{
		$this->db->where($condition_array);
		$query = $this->db->get($this->db_table_name);
		foreach ($query->result() as $row)
		{
			$attribute_groups_title = $row->attribute_groups_name;
			return $attribute_groups_title;
		}
	}
