        ...
        <div class="w3-row-padding">
            <div class="w3-col l9 m7 module_html">
                ...
                <div class="w3-row-padding toolbar">
                    ...
                    <select onchange="submit_form(this);" class="w3-select w3-small w3-padding-small w3-border w3-round" name="sort" style="width: 115px;">
					...
					<select onchange="submit_form(this);" class="w3-left w3-small w3-padding-small w3-select w3-border w3-round" name="per_page" style="width: 60px;">
            ...
            <div class="w3-col l3 m5 module_html search_box w3-responsive w3-margin-bottom">
                ...
                <div class="border w3-padding-small">
                    <div>
                        <input class="search_input w3-padding w3-border w3-round" name="search" type="text" value="<?php echo set_value('search',$search); ?>" placeholder="عبارت مورد نظر خود را جستجو کنید.">
                    </div>
                    ...
                    <button type="submit" class="w3-button w3-amber w3-text-black " style="width: 100%"><?=lang('search')?></button>
                </div>
            </div>
			<?php } ?>
        </div>
