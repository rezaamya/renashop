...
<div id="address_form" class="container-fluid">
	<?PHP
	...
	?>
        ...
        <div class="w3-row-padding">
            ...
            <input class="w3-col s9 w3-input w3-padding w3-border w3-round" name="address_title" type="text" placeholder="<?=lang('address_title')?>" value="<?php echo set_value('address_title', $address_title); ?>">
        </div>
        <div class="w3-row-padding">
            <label class="w3-col w3-margin-top s3"><?=lang('first_name')?></label>
            <input class="w3-col s9 w3-input w3-padding w3-border w3-round" name="address_first_name" type="text" placeholder="<?=lang('first_name')?>" value="<?php echo set_value('address_first_name', $first_name); ?>">
        </div>
        <div class="w3-row-padding">
            <label class="w3-col w3-margin-top s3"><?=lang('last_name')?></label>
            <input class="w3-col s9 w3-input w3-padding w3-border w3-round" name="address_last_name" type="text" placeholder="<?=lang('last_name')?>" value="<?php echo set_value('address_last_name', $last_name); ?>">
        </div>


        <div class="w3-row-padding">
            <label class="w3-col w3-margin-top s3"><?=lang('mobile')?></label>
            <input class="w3-col s9 w3-input w3-padding w3-border w3-round" name="address_mobile" type="text" placeholder="<?=lang('mobile')?>" value="<?php echo set_value('address_mobile', $mobile); ?>">
        </div>
        <div class="w3-row-padding">
            <label class="w3-col w3-margin-top s3"><?=lang('tel')?></label>
            <input class="w3-col s9 w3-input w3-padding w3-border w3-round" name="address_tel" type="text" placeholder="<?=lang('tel')?>" value="<?php echo set_value('address_tel', $tel); ?>">
        </div>
        <div class="w3-row-padding">
            <label class="w3-col w3-margin-top s3"><?=lang('postcode')?></label>
            <input class="w3-col s9 w3-input w3-padding w3-border w3-round" name="address_postcode" type="text" placeholder="<?=lang('postcode')?>" value="<?php echo set_value('address_postcode', $postcode); ?>">
        </div>
        <div class="w3-row-padding">
        ...
        <div class="w3-row-padding">
            ...
            <textarea class="w3-col s9 w3-input w3-padding w3-border w3-round" rows="3" name="address"><?php echo set_value('address',$complete_address); ?></textarea>
        </div>
        <div class="w3-row-padding">
            <label class="w3-col w3-margin-top s3">&nbsp;</label>
            <button type="submit" onclick="document.getElementById('task').value = 'save';" class="w3-button w3-round w3-green w3-margin-bottom"><?=lang('save')?></button>
            <button type="submit" onclick="document.getElementById('task').value = 'save_and_close';" class="w3-button w3-blue-gray w3-round w3-margin-bottom"><?=lang('save_and_close')?></button>
