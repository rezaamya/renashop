    ...
    <div class="w3-col s10 m6 l4 register">
        <div class="step_1">
            ...
            <div class="w3-container">
                ...
                <hr>
                <p class="content">با ايجاد يک حساب کاربری می توانید سريع تر خريد نموده، تاريخچه سفارش های خود را مشاهده کرده و همچنين از وضعيت سفارش خود آگاهی پيدا کرده و آن را پیگیری نمایید.
				</p>
            ...
            <button class="w3-button w3-block w3-dark-grey w3-hover-gray" onclick="register('step_1')"><?=lang('get_the_code')?></button>
        </div>
        <div class="step_2 w3-hide">
            ...
            <div class="w3-container">
				<p class="content">
					اگر «دریافت پیامک تبلیغاتی» را بر روی شماره همراه خود مسدود کرده باشید، «کد تائید ثبت‌نام» از طرف مخابرات برایتان ارسال نخواهد شد. در این صورت، یا از ایمیل جهت ثبت‌نام استفاده فرمائید و یا بطور موقت، امکان «دریافت پیامک تبلیغاتی» را بر روی شماره همراه خود فعال نمایید.
					<br/>
					لازم به ذکر است، همیشه میتوانید «بدون ثبت‌نام» و «به عنوان مهمان» سفارش خود را ثبت کنید.
				</p>
            ...
            <button class="w3-button w3-block w3-dark-grey w3-hover-gray" onclick="register('submit_code')"><?=lang('register')?></button>
        </div>
                ...
                postAjax(
                    ...
                    function (result) {
						...
						try {
							...
							var msg = '<div class="alert  w3-pale-red w3-round"><span class="closebtn" onclick="this.parentElement.style.display=\'none\';">&times;</span>سرور ارسال پیامک در دسترس نمیباشد. لطفا مجددا امتحان نمایید. در صورتیکه چندمین مرتبه است که این خطا را مشاهده میکنید، لطفا با مدیریت تماس حاصل نمایید.</div>';
							messages_holder.innerHTML = msg;
