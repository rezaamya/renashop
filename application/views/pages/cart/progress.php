    ...
    <div class="accordion_holder shipping_method">
        ...
        <div id="shipping_method" class="tab_content w3-hide">
            ...
            <div class="w3-row-padding">
                ...
                <p class="w3-margin-bottom w3-col m9 price_holder"></p>
            </div>
        ...
        function post_calculation(changed_el, request_is_from_region_select_field, show_error) {
            ...
            postAjax(url, send_to_server, function(result){
                ...
                if (result.status == 'successful')
                {
					...
					if (result.shipping_price == 0)
					{
						price_holder.innerHTML = 'هزینه ارسال: پرداخت توسط شما (در زمان تحویل) به مامور پست/پیک';
						final_shipping_price.innerHTML = 'پرداخت در محل به مامور پست/پیک';
					}
					else
					{
