...
<div id="cart" class="w3-container">
    <div>
        ...
        <span onclick="closest_parent(this, 'delete_modal').style.display='none';"
            ...
            <p>
                <a href="<?= base_url("cart/progress")?>" class="btn w3-button w3-round w3-green w3-left w3-margin-bottom w3-hover-gray">ثبت سفارش</a>
                <a href="<?= base_url("")?>"  class="btn w3-button w3-round w3-red w3-left w3-margin-bottom w3-hover-gray">برگشت به خرید</a>
            </p>
        </div>
    </div>
</div>
