...
<div id="login_register" class="w3-row">
    ...
    <div class="w3-col s10 m6 l4 login">
        <form action="<?=base_url('login')?>" method="post">
            ...
            <div class="w3-container">
                ...
                <div class="forgot_password">
                    <a href="<?=base_url('recover')?>"><?=lang('forgot_password')?></a>
                </div>
                <p class="w3-center">
                    <a href="<?=base_url('register')?>"><b><?=lang('you_are_not_a_member_click_here_to_join')?></b></a>
                </p>
            </div>

            <button type="submit" class="w3-button w3-block w3-dark-grey w3-hover-gray"><?=lang('login')?></button>
